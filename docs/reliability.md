...
Store timeout is seconds in Python and milliseconds in TypeScript, applied per
HTTP operation including reading the body, not to the whole turn. Redirects are
